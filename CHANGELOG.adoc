...
* * https://github.com/Huluvu424242/hazelcast-spring-boot-starter/issues/2[issue #2] Nitrite singleton instance fixed
...
=== Added
* https://github.com/Huluvu424242/hazelcast-spring-boot-starter/issues/1[issue #1] Projekt aufgesetzt
